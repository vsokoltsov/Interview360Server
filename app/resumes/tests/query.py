...
class ResumesQueryTest(TestCase):
    ...
    def test_receiving_of_the_resumes_list(self):
        ...
        self.assertEqual(
            ...
            [self.resume_1.id, self.resume_2.id,
             self.resume_3.id, self.resume_4.id]
        )
    ...
    def test_matching_the_order_of_list(self):
        ...
        self.assertEqual(
            [item.id for item in response],
            [self.resume_1.id, self.resume_3.id,
             self.resume_4.id, self.resume_2.id]
        )
    ...
    def test_opposite_list_order(self):
        ...
        self.assertEqual(
            [item.id for item in response],
            [self.resume_2.id, self.resume_4.id,
             self.resume_3.id, self.resume_1.id]
        )
